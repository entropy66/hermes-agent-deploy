...
def test_router_primary_cloud_without_failure() -> None:
    router = ModelRouter()
    out = router.invoke(
        StepType.PLAN,
        RiskLevel.HIGH,
